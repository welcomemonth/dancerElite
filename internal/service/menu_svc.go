...
func (s *MenuService) ensureDefaultMenuPermissions(ctx context.Context) error {
	permissions := map[string][]defaultPermission{
		...
		"seasons": {
			{Action: "list", Title: "查看赛季列表", Method: "GET", Sort: 1},
			{Action: "get", Title: "查看赛季详情", Method: "GET", Sort: 2},
			{Action: "create", Title: "新增赛季", Method: "POST", Sort: 3},
		...
		"annual-rankings": {
			{Action: "list", Title: "查看积分榜", Method: "GET", Sort: 1},
			{Action: "get", Title: "查看积分榜详情", Method: "GET", Sort: 2},
			{Action: "create", Title: "重算积分榜", Method: "POST", Sort: 3},
			{Action: "update", Title: "编辑积分榜", Method: "PUT", Sort: 4},
			{Action: "delete", Title: "删除积分榜", Method: "DELETE", Sort: 5},
		},
		"registrations": {
...
func permissionModule(menuName string) string {
	modules := map[string]string{
		...
		"annual-rankings":  "annual_ranking",
	}
